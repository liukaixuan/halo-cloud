...
import org.guzz.taglib.db.GhostAddInLimitTag;
...
public class GuzzAddInLimitDirective extends Directive {
	...
	public boolean render(InternalContextAdapter context, Writer writer, Node node) throws IOException, ResourceNotFoundException, ParseErrorException, MethodInvocationException {
		...
		if(node.jjtGetNumChildren() != 2){
			throw new RuntimeException(getName() + " accepts 2 parameter. The first is a boolean value indicating whether or not to add this conditon; the second is a Map!") ;
		}
